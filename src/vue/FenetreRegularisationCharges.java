...
public class FenetreRegularisationCharges extends JInternalFrame
     ...
     */
    public static void main(String[] args, DaoContratLocation dao,
        ContratLocation contrat, float element) {
        EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                try {
                    FenetreRegularisationCharges frame = new FenetreRegularisationCharges(
                        dao, contrat, element);
     ...
     * Create the frame.
     */
    public FenetreRegularisationCharges(DaoContratLocation dao,
        ContratLocation contrat, float element) {
        this.dao = dao;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        case "Continuer":
            contrat
                .setMontantMensuel(contrat.getMontantMensuel() + element / 12);
            try {
                dao.update(contrat);

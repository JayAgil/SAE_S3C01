...
public class RequeteUpdateContratLocation extends Requete<ContratLocation> {
    ...
    public String requete() {
        return "Update MSF5131A.SAE_ContratLocation "
        		+ "set Date_debut = ?,"
        		+ "Date_Fin = ?, Montant_de_caution = ?,"
        		+ "Provision_Charge = ?, Solde = ?,"
        		+ "Montant_Mensuel = ?, Date_versement = ?,"
        		+ "Index_Compteur_Eau  = ?, Index_Compteur_Electrcite = ?,"
        		+ "Index_Compteur_Gaz = ?"
